...
const DialogOverlay = React.forwardRef(({ className, WIN, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ...
    style={!WIN ? { backgroundImage: `url(${win})` } : undefined} // Conditionally apply the background image
    {...props}
  />
));
...
const DialogContent = React.forwardRef(
  ({ className, WIN, close, children, ...props }, ref) => (
    <DialogPortal>
